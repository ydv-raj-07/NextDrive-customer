...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.evilratt.instamjo.instamojo.InstamojoPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin instamojo, com.evilratt.instamjo.instamojo.InstamojoPlugin", e);
    }
    try {
