...
import '../pages/referralcode/PromocodeModal.dart';
...
//base url
String url =
    'https://admin.nextdriveindia.com/public/'; //add '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyCDWwome77AYHxUONWW3YgqM1BqRWTtJpE';
...
Future<List<Coupon>> fetchMatchList() async {
  final String apiUrl = '${url}api/v1/request/promocode-list';
  print("hello");
...
print(response.statusCode);
    if (response.statusCode == 200) {
      ...
      final List<Coupon> couponList = jsonData.map((item) => Coupon.fromJson(item)).toList();

      return couponList;
    } else {
      print('API Error: ${response.statusCode}');
      return []; // or throw an exception with appropriate error message
    }
  } catch (error) {
    print('Error while fetching match list: $error');
    // Handle error
    return []; // or throw an exception with appropriate error message
  }
}
