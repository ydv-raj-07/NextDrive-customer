      ...
      child: Directionality(
        ...
        child: Stack(
          children: [
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                    ...
                                    borderRadius: BorderRadius.circular(12),
                                    gapPadding: 1),
                                focusColor: const Color(0xfffcb13c),
                                focusedBorder: const OutlineInputBorder(
                                  borderSide: BorderSide(
                                    color: Color(
                                        0xfffcb13c), // Change this to the desired focus border color
                                    width:
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                focusColor: const Color(0xfffcb13c),
                                labelStyle:
                                    const TextStyle(color: Color(0xfffcb13c)),
                                border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(12),
                                    gapPadding: 1),
                                enabledBorder: OutlineInputBorder(
            ...
            Positioned(
                top: media.width*0.65,left:media.width*0.6 ,
                child: InkWell(  onTap: () {
                  setState(() {
                    _pickImage = true;
                  });
                },
                  child: SizedBox(height: media.width * 0.1,width: media.width * 0.1,
                      child: Image.asset(
                        'assets/images/camera.png',fit: BoxFit.fill,)),
                )),
