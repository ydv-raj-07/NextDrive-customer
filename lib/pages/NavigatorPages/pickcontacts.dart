...
//get contact permission
  ...
  List<Map<String, String>> originalContacts = [];
  void resetContacts() {
    setState(() {
      contacts.clear();
    });
        ...
        setState(() {
          ...
          if (searchController.text.isEmpty) {
            ...
            contactsList.forEach((contact) {
              contact.phones!.forEach((Item phone) {
                contacts.add({
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                    ...
                    child: Container(decoration: BoxDecoration(border: Border.all(color: Color(0xffdda403),width: 1),borderRadius: BorderRadius.circular(8)),
                      child: Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: TextField(
                          controller: searchController,
                          decoration: InputDecoration(border: InputBorder.none,
                            hintText: 'Search Contact by Phone number or name',hintStyle: TextStyle(fontSize: 12,color:
