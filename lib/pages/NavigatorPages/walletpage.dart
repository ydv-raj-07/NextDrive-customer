...
//get wallet details
  ...
  Widget build(BuildContext context) {
    ...
    String baseUrl = 'https://admin.nextdriveindia.com/payment';



    // Concatenate amount to the URL
    Uri concatenatedUrl = Uri.parse("$baseUrl/$email/$addMoney/phonepe");
                                          ...
                                          Button(
                                            onTap: () async {
                                              ...
                                              if (addMoney != 0 && addMoney != null) {
                                                ...
                                                openBrowser('$concatenatedUrl').then((result) {
                                                  ...
                                                  //   context,
                                                  //   MaterialPageRoute(
                                                  //     builder: (ctx) => YourDestinationScreen(),
                                                  //   ),
                                                  // );
                                                });
                                              }
