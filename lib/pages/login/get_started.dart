...
const Color customColor = Color(0xffa8acbf);
            ...
            children: [
              Container(
                padding: EdgeInsets.only(
                    left: media.width * 0.08,top: media.width * 0.09),
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding:  EdgeInsets.only(left:media.height * 0.06 ),
                            child: SizedBox(
                              width: media.width * 1,
                              child: Text(
                          ...
                          Padding(
                            padding:  EdgeInsets.only(left:media.height * 0.092 ),
                            child: Text(
                          ...
                          Padding(
                            padding:  EdgeInsets.only(right:media.height * 0.02 ),
                            child: Center(
                              child: InkWell(
                                onTap: () {
                                  setState(() {
                      ...
                      Padding(
                        padding:  EdgeInsets.only(right:media.height * 0.04 ),
                        child: TextField(
                        ...
                        enabledBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10.0),
                          borderSide: const BorderSide(color: customColor, width: 1.0),
                        ),
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10.0),
                          borderSide: const BorderSide(color: customColor, width: 2.0),
                        ),
                    ),
                onChanged: (val) {
                  setState(() {
                ...
                controller: nameText,
                style: const TextStyle(color: customColor), // Set text color
                cursorColor: customColor, // Set cursor color
                // Other properties and widgets can also use `customColor`.
              ),
                      )
              ...
              ,SizedBox(
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide(
                                    color: verifyEmailError == '' ? customColor : Colors.red, // Conditionally set border color
                                  ),
                                ),
                                focusedBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10.0),
                                  borderSide: const BorderSide(
                                    color: customColor, // Border color when focused
                                  ),
                                ),
                              ),
                              onChanged: (val) {
                          ...
                          (widget.from == '1')
                              ? Padding(
                            padding:  EdgeInsets.only(right:media.height * 0.04 ),
                                child: Container(height: media.height * 0.08,
                                    decoration: BoxDecoration(
                                        border: Border.all(color: customColor,),borderRadius: const BorderRadius.all(Radius.circular(9))
                                        // Border(
                                        //     bottom: BorderSide(
                                        //         color: (isDarkTheme == true)
                                      //             ? textColor.withOpacity(0.6)
                              ...
                              : Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 10),
                                      Container(decoration: BoxDecoration(border: Border.all(),borderRadius: const BorderRadius.all(Radius.circular(10))),
                                        height: 50,
                                        alignment: Alignment.center,
                                        width: media.width * 0.5,
                                        child: TextFormField(
                              ...
                              ? (nameText.text.isNotEmpty &&
                                  ...
                                  ? Padding(
                                    ...
                                    child: Container(
                                        width: media.width * 1,
                                        alignment: Alignment.center,
                                        child: Button(width: media.width*0.75,
                                            onTap: () async {
                                              String pattern =
