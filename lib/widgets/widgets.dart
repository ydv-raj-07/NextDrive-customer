      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors:(widget.LinearGradient!=null)?widget.LinearGradient:[const Color(0xffffd52b),const Color(0xffffc00d)],
            ),
            borderRadius: BorderRadius.circular(8),
            color: (widget.color == null) ?  const Color(0xffffd52b):widget.color ,
            border: Border.all(
              color: (widget.borcolor != null) ? widget.borcolor :  const Color(0xffffd52b),
              width: 1,
            )),
